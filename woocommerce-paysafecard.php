...
function paysafecard_init_gateway_class() {
    ...
    class WC_Paysafecard_Gateway extends WC_Payment_Gateway {
        ...
        public function process_payment( $order_id ) {
            ...
            $response = $pscpayment->createPayment($order->get_total(), $order->get_currency(), $customerhash, $order->get_customer_ip_address(), $success_url, $failure_url, $notification_url, $correlation_id = "");
